...
func CopiedReader(reader io.Reader, multiple int, done <-chan bool, filters ...Filter) (inputs []io.Reader) {
...
func MergedWriter(writer io.Writer, n int, done <-chan bool, filters ...Filter) (outputs []io.Writer) {
